...
import java.util.Vector;
 ...
 class IceCreamShop {
    ...
    public static void main(String[] args) {
        ...
        // Ice cream flavors and prices stored in Vectors
        Vector<String> flavors = new Vector<>();
        Vector<Double> prices = new Vector<>();

        // Add flavors and prices to the Vector
        flavors.add("Vanilla");
        ...
        // Vector to store selected flavors
        Vector<String> selectedFlavors = new Vector<>();
